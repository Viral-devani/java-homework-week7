/*
Write a method isLeapYear with a parameter of type int named year. The parameter needs to be greater than or equal to 1
and less than or equal to 9999. If the parameter is not in that range return false. Otherwise,
 if it is in the valid range, calculate
if the year is a leap year and return true if it is, otherwise return false.
...
If parameter month is < 1 or >12 return -1. If parameter year is <1 or >9999 than return -
1. This method needs to return the number of days in the month.
...
public class Program4 {
    ...
    public static boolean isLeapYear(int years) {
        ...
        if (years <= 1 || years >= 9999) {
            b = false;
            System.out.println(b + "  since parameter is not in range(1-9999)");

        } else if (years % 4 == 0 && years % 100 != 0 || years % 400 == 0) {
            b = true;
            System.out.println(b + "  Since " + years + " is a leap year");
        } else {
            b = false;
            System.out.println(b + "  since " + years + " is not a leap year");
        }
        return b;
    }
